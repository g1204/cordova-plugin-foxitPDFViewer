...
## Example
    ...
    var alertError = function(msg) { alert(msg); };
    pdfViewer.initLibrary(sn, key, function(msg) { pdfViewer.openSamplePDF(function(msg){ pdfViewer.loadExtensions(function(msg){}, alertError); }, alertError); }, alertError);
    }
